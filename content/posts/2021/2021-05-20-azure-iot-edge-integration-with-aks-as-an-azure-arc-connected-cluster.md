...
images  = ["images/posts/azure_arc_jumpstart_logo.png"]
thumbnail = "images/posts/azure_arc_jumpstart_logo.png"
comment = false
+++

>**This scenario was published in [Azure Arc JumpStart](https://azurearcjumpstart.io/azure_arc_jumpstart/azure_arc_k8s/iot_uses_cases/aks/)**
...
* Run the ```terraform init``` command which will download the Terraform AzureRM provider.
    ...
    ![Screenshot showing terraform init being run](images/posts/Arc_IoT_AKS_01.png)
...
* Run the ```terraform apply -auto-approve`` command and wait for the plan to finish.
    ...
    ![Screenshot showing terraform plan completing](images/posts/Arc_IoT_AKS_02.png)

    ![Screenshot showing Azure Portal with AKS resource](images/posts/Arc_IoT_AKS_03.png)

    ![Screenshot showing Azure Portal with AKS resource](images/posts/Arc_IoT_AKS_04.png)
...
* In order to keep your local environment clean and untouched, we will use [Azure Cloud Shell](https://docs.microsoft.com/en-us/azure/cloud-shell/overview) (located in the top-right corner in the Azure portal) to run the next commands:
    ...
    ![Screenshot showing how to access Cloud Shell in Visual Studio Code](images/posts/Arc_IoT_AKS_05.png)
...
az iot hub device-identity connection-string show --device-id "EdgeDeviceSim" --hub-name k8sedgejumpstart
  ...
  ![Screenshot showing how to access Cloud Shell in Visual Studio Code](images/posts/Arc_IoT_AKS_06.png)

  ![Screenshot showing how to access Cloud Shell in Visual Studio Code](images/posts/Arc_IoT_AKS_07.png)
...
![Screenshot showing sync config IoT Edge device in VM](images/posts/Arc_IoT_AKS_08.png)
...
![Screenshot showing sync config IoT Edge device in VM](images/posts/Arc_IoT_AKS_09.png)
...
![Screenshot showing IoT Edge device in IoT Hub](images/posts/Arc_IoT_AKS_10.png)

![Screenshot showing IoT Edge device in IoT Hub](images/posts/Arc_IoT_AKS_11.png)
...
![Screenshot showing IoT Edge modules running in the device](images/posts/Arc_IoT_AKS_12.png)
...
![Screenshot environment variables section](images/posts/Arc_IoT_AKS_13.png)
...
![Screenshot environment variables section](images/posts/Arc_IoT_AKS_16.png)
...
![Screenshot showing delete function in Azure Portal](images/posts/Arc_IoT_AKS_14.png)
...
![Screenshot showing terraform destroy being run](images/posts/Arc_IoT_AKS_15.png)
